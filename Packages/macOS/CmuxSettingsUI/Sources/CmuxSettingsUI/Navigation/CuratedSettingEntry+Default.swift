...
extension Array where Element == CuratedSettingEntry {
    private static var accountEntries: [CuratedSettingEntry] {
        [
    ...
    private static var appEntries: [CuratedSettingEntry] {
        [
        // App
    ...
    private static var terminalEntries: [CuratedSettingEntry] {
        [
        // Terminal
            .init(
                section: .terminal,
    ...
    private static var textBoxEntries: [CuratedSettingEntry] {
        [
        // TextBox
    ...
    private static var sidebarAppearanceEntries: [CuratedSettingEntry] {
        [
    ...
    private static var mobileEntries: [CuratedSettingEntry] {
        [
        // Mobile
            .init(
                section: .mobile,
    ...
    private static var customSidebarsEntries: [CuratedSettingEntry] {
        [
        // Custom Sidebars
    ...
    private static var betaFeaturesEntries: [CuratedSettingEntry] {
        [
        // Beta
    ...
    private static var automationEntries: [CuratedSettingEntry] {
        [
        // Automation
    ...
    private static var computerUseEntries: [CuratedSettingEntry] {
        [
        // Computer Use
            .init(
                section: .computerUse,
    ...
    private static var browserEntries: [CuratedSettingEntry] {
        [
        // Browser
    ...
    private static var browserImportEntries: [CuratedSettingEntry] {
        [
        // Browser import
    ...
    private static var globalHotkeyEntries: [CuratedSettingEntry] {
        [
        // Global hotkey
    ...
    private static var keyboardShortcutsEntries: [CuratedSettingEntry] {
        [
        // Keyboard shortcuts
            .init(
    ...
    private static var workspaceColorsEntries: [CuratedSettingEntry] {
        [
        // Workspace colors
    ...
    private static var settingsJSONEntries: [CuratedSettingEntry] {
        [
        // cmux.json
    ...
    private static var resetEntries: [CuratedSettingEntry] {
        [
        // Reset
