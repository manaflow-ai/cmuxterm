...
export const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      {
        id: "movePaneToOuterLeft",
        combos: [],
        description: { en: "Move pane to new outer split on left", ja: "ペインを左側の新しい外側分割へ移動" },
        note: { en: "unbound by default; split workspaces only", ja: "デフォルトでは未割り当て。分割ワークスペースでのみ使用可能" },
      },
      {
        id: "movePaneToOuterRight",
        combos: [],
        description: { en: "Move pane to new outer split on right", ja: "ペインを右側の新しい外側分割へ移動" },
        note: { en: "unbound by default; split workspaces only", ja: "デフォルトでは未割り当て。分割ワークスペースでのみ使用可能" },
      },
      {
        id: "movePaneToOuterTop",
        combos: [],
        description: { en: "Move pane to new outer split above", ja: "ペインを上側の新しい外側分割へ移動" },
        note: { en: "unbound by default; split workspaces only", ja: "デフォルトでは未割り当て。分割ワークスペースでのみ使用可能" },
      },
      {
        id: "movePaneToOuterBottom",
        combos: [],
        description: { en: "Move pane to new outer split below", ja: "ペインを下側の新しい外側分割へ移動" },
        note: { en: "unbound by default; split workspaces only", ja: "デフォルトでは未割り当て。分割ワークスペースでのみ使用可能" },
      },
