  ...
  },
  {
    ...
    shortcuts: [
      ...
      },
      {
        ...
        combos: [["⌃", "7"]],
        description: {
          en: "Show Cloud Machines in the right sidebar",
          ja: "右サイドバーに Cloud Machines を表示",
          "zh-CN": "在右侧边栏显示云机器",
          "zh-TW": "在右側邊欄顯示雲端機器",
          ko: "오른쪽 사이드바에 클라우드 머신 표시",
          de: "Cloud-Maschinen in der rechten Seitenleiste anzeigen",
          es: "Mostrar máquinas en la nube en la barra lateral derecha",
          fr: "Afficher les machines cloud dans la barre latérale droite",
          it: "Mostra le macchine cloud nella barra laterale destra",
          da: "Vis cloudmaskiner i højre sidepanel",
          pl: "Pokaż maszyny w chmurze na prawym pasku bocznym",
          ru: "Показать облачные машины в правой боковой панели",
          bs: "Prikaži cloud mašine u desnoj bočnoj traci",
          ar: "إظهار الأجهزة السحابية في الشريط الجانبي الأيمن",
          no: "Vis skymaskiner i høyre sidepanel",
          "pt-BR": "Mostrar máquinas na nuvem na barra lateral direita",
          th: "แสดงเครื่องคลาวด์ในแถบด้านขวา",
          tr: "Bulut makinelerini sağ kenar çubuğunda göster",
          km: "បង្ហាញម៉ាស៊ីន Cloud នៅក្នុងរបារចំហៀងខាងស្តាំ",
          uk: "Показати хмарні машини на правій бічній панелі",
        },
        note: {
          en: "Cloud Machines uses Ctrl+7 by default; enable Cloud Machines in Settings > Beta Features or via rollout.",
          ja: "Cloud Machines のデフォルトは Control+7 です。設定 > ベータ機能で Cloud Machines を有効にするか、ロールアウトを利用してください。",
          "zh-CN": "云机器默认使用 Ctrl+7；请在“设置”>“测试功能”中启用云机器，或等待远程发布。",
          "zh-TW": "雲端機器預設使用 Ctrl+7；請在「設定」>「測試功能」中啟用雲端機器，或等待遠端推出。",
          ko: "클라우드 머신은 기본적으로 Ctrl+7을 사용합니다. 설정 > 베타 기능에서 활성화하거나 롤아웃을 기다리세요.",
          de: "Cloud-Maschinen verwenden standardmäßig Strg+7. Aktivieren Sie sie unter Einstellungen > Betafunktionen oder per Rollout.",
          es: "Las máquinas en la nube usan Ctrl+7 de forma predeterminada; actívalas en Configuración > Funciones beta o mediante el lanzamiento gradual.",
          fr: "Les machines cloud utilisent Ctrl+7 par défaut ; activez-les dans Réglages > Fonctionnalités bêta ou via le déploiement.",
          it: "Le macchine cloud usano Ctrl+7 per impostazione predefinita; abilita Cloud Machines in Impostazioni > Funzionalità beta o tramite rollout.",
          da: "Cloudmaskiner bruger Ctrl+7 som standard; aktivér dem under Indstillinger > Betafunktioner eller via udrulning.",
          pl: "Maszyny w chmurze domyślnie używają Ctrl+7; włącz je w Ustawienia > Funkcje beta lub przez wdrożenie.",
          ru: "Облачные машины используют Ctrl+7 по умолчанию; включите их в Настройки > Бета-функции или дождитесь rollout.",
          bs: "Cloud mašine podrazumijevano koriste Ctrl+7; omogućite ih u Postavke > Beta funkcije ili kroz rollout.",
          ar: "تستخدم الأجهزة السحابية Ctrl+7 افتراضيًا؛ فعّلها من الإعدادات > الميزات التجريبية أو عبر الطرح التدريجي.",
          no: "Skymaskiner bruker Ctrl+7 som standard; aktiver dem under Innstillinger > Betafunksjoner eller via utrulling.",
          "pt-BR": "As máquinas na nuvem usam Ctrl+7 por padrão; ative-as em Ajustes > Recursos beta ou pelo rollout.",
          th: "Cloud Machines ใช้ Ctrl+7 เป็นค่าเริ่มต้น เปิดใช้ที่ การตั้งค่า > ฟีเจอร์เบต้า หรือผ่านการทยอยเปิดใช้",
          tr: "Bulut makineleri varsayılan olarak Ctrl+7 kullanır; Ayarlar > Beta Özellikleri'nden veya rollout ile etkinleştirin.",
          km: "Cloud Machines ប្រើ Ctrl+7 តាមលំនាំដើម។ សូមបើកនៅ ការកំណត់ > មុខងារបេតា ឬរង់ចាំ rollout។",
          uk: "Хмарні машини типово використовують Ctrl+7; увімкніть їх у Налаштуваннях > Бета-функції або дочекайтеся rollout.",
        },
      },
      {
