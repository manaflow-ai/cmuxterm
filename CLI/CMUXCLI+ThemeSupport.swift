...
extension CMUXCLI {
    ...
    func isRightSidebarCLIMode(_ value: String) -> Bool {
        ...
        case "files", "find", "vault", "artifacts", "sessions", "feed", "dock", "cloud", "machines", "vms", "custom", "custom-sidebar":
            return true
        default:
            return false
        }
    ...
    func normalizedRightSidebarCLIArgument(_ value: String) -> String {
        switch value.lowercased() {
        case "files", "find", "vault", "artifacts", "sessions", "feed", "dock", "machines", "custom", "custom-sidebar":
