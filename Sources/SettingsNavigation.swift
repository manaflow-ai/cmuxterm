...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "workspace-order", String(localized: "settings.sidebar.workspaceOrder", defaultValue: "Workspace Order"), "sidebar workspace notification creation manual custom sort order"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.reorderOnNotification": settingID(for: .sidebarAppearance, idSuffix: "workspace-order"),
        ...
        "sidebar.workspaceOrder": settingID(for: .sidebarAppearance, idSuffix: "workspace-order"),
