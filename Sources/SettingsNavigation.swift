...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.computers, "pair", String(localized: "settings.section.computers", defaultValue: "Computers"), String(localized: "settings.computers.keywords", defaultValue: "computers devices mac tailscale pairing remote workspaces")),
