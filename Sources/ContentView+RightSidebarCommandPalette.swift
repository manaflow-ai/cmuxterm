...
extension ContentView {
    ...
    static func commandPaletteRightSidebarModeCommandContributions() -> [CommandPaletteCommandContribution] {
        ...
        return RightSidebarMode.availableModes().filter { $0.shortcutAction != nil || $0 == .artifacts }.map { mode in
    ...
    private static func commandPaletteRightSidebarToolPaneCommandID(_ mode: RightSidebarMode) -> String? {
        ...
        case .artifacts:
            return "palette.openArtifactsPane"
    ...
    private static func commandPaletteRightSidebarToolPaneTitle(_ mode: RightSidebarMode) -> String? {
        ...
        case .artifacts:
            return String(localized: "command.openArtifactsPane.title", defaultValue: "Open Artifacts as Pane")
        case .feed, .dock, .machines, .customSidebar:
            return nil
        }
    }
