...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "sidebarAppearance:workspace-order": "sidebar.workspaceOrder app.reorderOnNotification workspace order sort notification recency creation created manual drag custom function javascript",
