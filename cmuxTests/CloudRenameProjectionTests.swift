...
/// Rename coverage at the current graph/ordering owners, replacing obsolete
/// SurfaceCatalog mutation-token tests. Cursorless metadata and stale/equal
/// receipts remain covered by staleMachineMetadataPreservesCanonicalWorkspaceNames
/// and remoteMutationReceiptsFenceDelayedGraphs respectively.
@MainActor
@Suite
