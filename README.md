...
- The new rename-delta regression drives the real parser and sidebar builder, checking the shown row, hidden-tab ordering, and subsequent full refresh for both omitted and explicit indices. Its app-hosted execution remains subject to the same test-target blocker.
